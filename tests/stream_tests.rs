...
// #[test]
// fn test_xread_multiple_streams_basic() {
...
// #[test]
// fn test_xread_multiple_streams_advanced() {
//     let redis = setup_test_stream();
...
// #[test]
// fn test_xread_with_count_simple() {
//     let redis = setup_test_stream();
...
// #[test]
// fn test_xread_with_count_advanced() {
//     let redis = setup_test_stream();
...
//         fields.insert("field1".to_string(), "value3".to_string());
...
//     assert_eq!(entries[1].fields["field1"], "value2");
//     assert_eq!(entries[2].id, "3-0");
//     assert_eq!(entries[2].fields["field1"], "value3");
// }
...
//         let handler = XReadHandler::new(redis_clone, request);
//         handler.run_loop()
//     });
...
//         redis_guard.storage.xadd("stream2", "1-0", fields.clone()).unwrap();
        
//         fields.insert("field1".to_string(), "value2".to_string());
//         redis_guard.storage.xadd("stream1", "2-0", fields.clone()).unwrap();
//         redis_guard.storage.xadd("stream2", "2-0", fields).unwrap();
//     }
...
//     assert_eq!(stream1_entries.len(), 2);
//     assert_eq!(stream1_entries[0].id, "1-0");
//     assert_eq!(stream1_entries[0].fields["field1"], "value1");
//     assert_eq!(stream1_entries[1].id, "2-0");
//     assert_eq!(stream1_entries[1].fields["field1"], "value2");
    
//     let (stream2_name, stream2_entries) = &results[1];
//     assert_eq!(stream2_name, "stream2");
//     assert_eq!(stream2_entries.len(), 2);
//     assert_eq!(stream2_entries[0].id, "1-0");
//     assert_eq!(stream2_entries[0].fields["field1"], "value1");
//     assert_eq!(stream2_entries[1].id, "2-0");
//     assert_eq!(stream2_entries[1].fields["field1"], "value2");
// }

// #[test]
// fn test_xread_multiple_streams_original() {
//     let mut redis = test_redis();
...
//         let mut fields = HashMap::new();
//         fields.insert("temperature".to_string(), "25".to_string());
//         redis.storage.xadd("sensor:1", "1-0", fields.clone()).unwrap();
        
//         fields.insert("temperature".to_string(), "26".to_string());
//         redis.storage.xadd("sensor:2", "2-0", fields).unwrap();
//     }

//     let request = XReadRequest {
//         keys: vec!["sensor:1".to_string(), "sensor:2".to_string()],
//         ids: vec!["0-0".to_string(), "0-0".to_string()],
//         block: None,
//         count: None,
//     };
...
//     assert_eq!(stream_name, "sensor:2");
//     assert_eq!(entries.len(), 1);
//     assert_eq!(entries[0].id, "2-0");
//     assert_eq!(entries[0].fields["temperature"], "26");
// }
